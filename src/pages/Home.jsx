        ...
        <div className='container mx-auto py-4 flex flex-col md:flex-row space-x-2'>
          ...
          <div className='w-full md:w-9/12 mt-8 md:mt-0 h-96 relative'>
            ...
            <div className='absolute top-16 left-8'>
              <p className='text-grey-600 mb-4'>code with me</p>
              <h2 className='text-3xl font-bold'>WELCOME TO YOUR ONLINE-SHOP</h2>
              <p className='text-xl mt-2.5 font-bold text-grey-600'>Millions + products </p>
